...
function addStats(){
  ...
  if (solvesAmount == 1){
    ...
    myArea.value += "\nSize: " + N + "x" + N;
    myArea.value += "\nMode: " + modeName + "\n";
    myArea.value += "\nTime\tao5\tao12\tReaction\tao5\tao12\n";  /*TOCHANGE*/
    sessionTimesAdded = false;
  }
  
  /*TOCHANGE*/
 myArea.value += currentTime;
 myArea.value += "\t";
 myArea.value += getAo(5, solvesT);
 myArea.value += "\t";
 myArea.value += getAo(12, solvesT);
 myArea.value += "\t";
 myArea.value += currentReactAvg;
 myArea.value += "\t";
 myArea.value += getAo(5, solvesR);
 myArea.value += "\t";
 myArea.value += getAo(12, solvesR);
 myArea.value += "\n";
  /*TOCHANGE*/
  
 addSinT([solvesAmount, currentTime, getAo(5, solvesT), getAo(12, solvesT), currentReactAvg, getAo(5, solvesR), getAo(12, solvesR)],solvesTable, true); 
   /*TOCHANGE*/
